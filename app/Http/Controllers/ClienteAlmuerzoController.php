...
class ClienteAlmuerzoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('clientesalmuerzos.index')->with('success', 'Cliente agregado exitosamente.');
    }
    ...
    public function destroy($id)
    {
        ...
        $cliente->delete();
        return redirect()->route('clientesalmuerzos.index')->with('success', 'Cliente eliminado exitosamente.');
    }
}