...
// Rutas para el panel
Route::get('/', [PanelController::class, 'dashboard'])->name('panel.dashboard');
...
Route::get('/ordenesalmuerzos', [OrdenAlmuerzoController::class, 'index'])->name('ordenesalmuerzos.index');
Route::get('/ordenesalmuerzos/create', [OrdenAlmuerzoController::class, 'create'])->name('ordenesalmuerzos.create');
